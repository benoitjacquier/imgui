...
namespace ImGui
{
	...
	IMGUI_API void          ColorPicker( bool *opened, float col[4]);
...
struct ImDrawList
{
	...
	IMGUI_API void  AddColorRectFilled(const ImVec2& a, const ImVec2& b, ImU32 col1, ImU32 col2, ImU32 col3, ImU32 col4);
